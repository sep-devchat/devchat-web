		...
		<S.Container>
			...
			>
				...
				<ResizablePanel defaultSize={22} minSize={16} maxSize={35}>
					<ChangeHistory changes={changes} onChangeClick={setSelectedDiff} />
				</ResizablePanel>
			</ResizablePanelGroup>
			...
			{showLoadConfirm && (
				<S.ModalOverlay>
					...
					<S.ModalContent>
						...
						<S.ModalDescription>
							You have unsaved changes. Loading this version will discard your
							current edits. Do you want to continue?
						</S.ModalDescription>
						<S.ModalActions>
							<S.CancelButton onClick={cancelLoadVersion}>
								Cancel
							</S.CancelButton>
							<S.DiscardButton onClick={confirmLoadVersion}>
								Discard & Load
							</S.DiscardButton>
						</S.ModalActions>
					</S.ModalContent>
