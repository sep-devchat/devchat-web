						...
						{isHalf ? (
							...
							<div className="h-full relative">
								<div className="absolute top-0 left-0 right-0 z-10 flex pointer-events-none">
									<div className="flex-1 flex items-center justify-between px-4 py-2.5 border-b border-red-500/30 bg-red-950/90 backdrop-blur-sm pointer-events-auto">
										<span className="text-sm font-semibold text-red-400">
											Original Code
										</span>
										<S.RunButton
									...
									<div className="flex-1 flex items-center justify-between px-4 py-2.5 border-b border-green-500/30 bg-green-950/90 backdrop-blur-sm pointer-events-auto">
										<span className="text-sm font-semibold text-green-400">
											Modified Code
										</span>
										<S.RunButton
					...
					<DialogHeader className="space-y-3 pb-4 border-b border-slate-700">
						<div className="flex items-center gap-3">
							...
							<button
								...
								className="p-2 rounded-lg hover:bg-slate-800 transition-colors group outline-none ring-0 focus:ring-0"
