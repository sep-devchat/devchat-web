        ...
        <>
            <HomeWrapper>
                <div className='toolbar'>
                    <Select value={locale} onValueChange={(val) => switchLanguage(val as 'en' | 'vi')}>
                ...
                <h1 style={{ margin: '8px 0', opacity: 0.9 }}>
                    {t('appName')}
                </h1>
                <div className="card">
                ...
                <div className="guide">
                    ...
                    <div className="guide-card">
                        ...
                        <div className="grid-2">
                            <ul>
                                <li><code>src/routes/index.ts</code>: TanStack Router route tree</li>
                                <li><code>src/providers.tsx</code>: App providers (Router + React Query)</li>
                                <li><code>src/components/ui</code>: Shadcn UI components</li>
                            </ul>
                            <ul>
                                <li><code>src/services</code>: API callers (axios)</li>
                                <li><code>src/pages</code>: Page components (one folder per page)</li>
...
<Button variant="secondary">Click me</Button>`}</pre>
                    ...
                    <div className="callout">
                        <span className="icon">💡</span>
                        <p>
                            Tip: Prefer React Query for server-side data fetching and caching. Use Redux only for client-side UI state.
                            Check <code>README.md</code> and <code>docs/TEAM_GUIDE.md</code> for details.
                        </p>
                    </div>
                </div>
            </HomeWrapper>
