...
import { AddEmailButton, Avatar, EditButton, EmailAddress, EmailDetails, EmailIcon, EmailItem, EmailSection, EmailSectionTitle, EmailTime, FormContainer, FormContent, FormGroup, FormRow, Input, Label, ProfileDetails, ProfileEmail, ProfileHeader, ProfileInfo, ProfileName, SelectAccount } from './SettingsItems.styled';
                ...
                <FormRow>
                    ...
                    <FormGroup>
                        ...
                        <SelectAccount
                            ...
                            onChange={(e: any) => handleInputChange('usageType', e.target.value)}
                        >
