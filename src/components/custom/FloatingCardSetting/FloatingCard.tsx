	...
	return (
		<Wrapper role="status" aria-live="polite" className={className}>
			...
			<div className="flex items-start gap-3 min-w-0">
				...
				<div className="text-sm leading-tight text-gray-700 min-w-0 truncate">
					{message}
				</div>
			</div>
			...
			<div className="flex items-center gap-3 shrink-0">
				{actions.map((a, idx) => {
					...
					const base =
						"inline-flex items-center justify-center px-3 py-1.5 rounded-md text-sm font-medium focus:outline-none focus:ring-2 focus:ring-offset-2";
