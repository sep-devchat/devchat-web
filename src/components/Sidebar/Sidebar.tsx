...
import { sampleData, SampleData, GroupSummary, ExpandedGroup } from '../../sampleData';
...
export const SidebarMenu: React.FC<SidebarMenuProps> = ({
    ...
    const [selectedGroupId, setSelectedGroupId] = useState<string | null>(data.expanded_group.group_id);
                  ...
                  Ngược lại -> hiển thị channel của expanded group */}
                            {logoMode ? (
                                ...
                                expanded.channels.map(ch => (
                                    <MenuItem
                                        key={ch.channel_id}
                                        $isActive={activeSection === ch.name || activeSection === ch.channel_id}
